...
class Card:
  ...
  def __str__(self):
    return f"{self.ranks['rank']} of {self.suits}"
...
class Hand:
  ...
  def calculate_value(self):
     ...
     for card in self.cards:
       card_value = int(card.ranks["value"])
       self.value += card_value
       if card.ranks["rank"] == "A":
         has_ace = True
  ...
  def check_winner(self, player_hand, \
    ...
    if not game_over:
      if player_hand.get_value() > 21:
        ...
        return True
      elif player_hand.is_blackjack() and \
      ...
      if player_hand.get_value() > \
        dealer_hand.get_value():
        print("You win!")
      elif player_hand.get_value() == \
        dealer_hand.get_value():
        print("It's a tie!")
      else:
        print("Dealer wins!")
